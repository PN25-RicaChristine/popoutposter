...
class Varnish extends Integration {
	...
	public function shouldLoadIntegration() {
		return $this->settings->is_mapps_site
			&& ! empty( $_SERVER['HTTP_X_VARNISH'] )
			&& get_site_option( 'permalink_structure' )
			&& ! self::isPluginActive( 'varnish-http-purge/varnish-http-purge.php' )
			&& ! self::isPluginBeingActivated( 'varnish-http-purge/varnish-http-purge.php' );
	}
