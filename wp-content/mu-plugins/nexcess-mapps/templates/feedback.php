...
<p><?php esc_html_e( 'As a member of the Nexcess Managed Applications Beta program, your sites get early-access to some of the new and exciting features we\'ve been working on.', 'nexcess-mapps' ); ?></p>
