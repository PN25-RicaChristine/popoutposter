...
var colors = "cc3333,993333,ffcccc,ff9999,33cc33,339933,ccffcc,99ff99".split(',').map(function (s) {
  return '#' + s;
});
var datasets = window.mc4wp_statistics_data.map(function (s, i) {
  s.fill = false;
...
_chart["default"].plugins.register({
  afterDraw: function afterDraw(chart) {
    if (chart.data.datasets.length === 0) {
      ...
      _ctx.font = "16px normal 'Helvetica Nueue'";

      _ctx.fillText('No data to display', width / 2, height / 2);
...
var settings = window.mc4wp_statistics_settings || {};
var dateRangeSelectorElement = document.getElementById('mc4wp-graph-range');
var customRangeOptionsElement = document.getElementById('mc4wp-graph-custom-range-options');
var ctx = document.getElementById('mc4wp-graph').getContext('2d');
...
dateRangeSelectorElement.addEventListener('change', function (evt) {
