...
class Admin {
	...
	public function load_assets() {
		...
		wp_enqueue_style( 'mailchimp-user-sync-admin', $this->asset_url( "/css/admin{$min}.css" ) );
		wp_enqueue_script( 'mailchimp-user-sync-wizard', $this->asset_url( "/js/admin{$min}.js" ), array(), MC4WP_USER_SYNC_PLUGIN_VERSION, true );
