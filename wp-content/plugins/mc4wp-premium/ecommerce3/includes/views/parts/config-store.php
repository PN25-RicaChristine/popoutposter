    ...
    ?>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <div class="help"><?php _e('Should adding orders or carts to Mailchimp send out e-commerce automations? Do not forget to re-enable this after you are done connecting your store to Mailchimp.', 'mc4wp-ecommerce'); ?></div>
            </td>
        </tr>
    </table>
