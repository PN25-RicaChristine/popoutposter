...
class MC4WP_Ecommerce_Admin
{
    ...
    */
	...
	/**
	 * @var MC4WP_Ecommerce_Product_Syncer
	 */
    protected $product_syncer;

	/**
	 * @var MC4WP_Ecommerce_Order_Syncer
	 */
    protected $order_syncer;
	 ...
	 * @param MC4WP_Ecommerce_Product_Syncer $product_syncer
	 * @param MC4WP_Ecommerce_Order_Syncer $order_syncer
	 */
    public function __construct($plugin_file, $queue, array $settings, MC4WP_Ecommerce_Product_Syncer $product_syncer, MC4WP_Ecommerce_Order_Syncer $order_syncer)
    {
    	$this->plugin_file = $plugin_file;
        $this->queue = $queue;
        $this->settings = $settings;
        $this->product_syncer = $product_syncer;
        $this->order_syncer = $order_syncer;
    ...
    */
    ...
    public function admin_notices() {
        ...
        if ($this->settings['store']['is_syncing']) {
