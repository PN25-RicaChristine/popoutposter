		...
		<tr valign="top">
			...
			<td>
                ...
                if ($license->activated) {
                    echo sprintf('<p><span class="status positive">%s</span> - %s</p>', __('ACTIVE', 'mailchimp-for-wp'), __('you are receiving plugin updates', 'mailchimp-for-wp'));
                } else {
                	echo sprintf('<p><span class="status negative">%s</span> - %s</p>', __('INACTIVE', 'mailchimp-for-wp'), __('you are <strong>not</strong> receiving plugin updates right now', 'mailchimp-for-wp'));
                } ?>
			</td>
		</tr>
	</table>
