...
{    
    ...
    {
        $nickx_src = PLUGIN_URL.'/?secret_key=5eb1c4a02b79b2.58781010&slm_action=slm_activate&license_key='.$key.'&registered_domain='.get_site_url().'&item_reference=wc_product_video_gallery';
    ...
    public function nickx_deactive()
    {
        ...
        $deact_url = PLUGIN_URL.'/?secret_key=5eb1c4a02b79b2.58781010&slm_action=slm_deactivate&license_key='.$nickx_lic['l'].'&registered_domain='.get_site_url();
